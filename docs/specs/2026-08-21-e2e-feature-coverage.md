...
**Date:** 2026-08-21  
**Status:** Phase 1 implemented (2026-08-22, merged to main via PR #49) — suite since grown from 9 to 14 spec files; Phase 2 not started (`ci.yml` has checks jobs only, no e2e job)
